...
public final class SnowFlakeIdUtil {
     ...
     */
    SnowFlakeIdUtil(long workerId, long datacenterId, long standbyDatacenterId) {
     ...
     * 使用双重校验获取实例对象
     */
    private volatile static SnowFlakeIdUtil snowflakeIdWorker;
    public static SnowFlakeIdUtil getInstance() {
        if (snowflakeIdWorker == null) {
            synchronized (SnowFlakeIdUtil.class) {
                if (snowflakeIdWorker == null) {
                    snowflakeIdWorker = new SnowFlakeIdUtil(1, 0,11);
                }
            }
        }
